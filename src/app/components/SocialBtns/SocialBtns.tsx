...
export default function SocialBtns() {
    return (
        <div className="social">
            <a target="_blank" href="https://www.instagram.com/caiosilvamap/">
                <Icon src="/insta-icon.svg" alt="icon insta" width={20} height={20} />
            </a>
            <a target="_blank" href="https://www.linkedin.com/in/caiosilvamap/">
                <Icon src="/linkedin-icon.svg" alt="icon LinkedIn" width={20} height={20} />
            </a>
            <a target="_blank" href="https://github.com/caiosilvamap">
                <Icon src="/github-icon.svg" alt="icon GitHub" width={20} height={20} />
            </a>
            <a target="_blank" href="https://wa.me/5524998331776">
