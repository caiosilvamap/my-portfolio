    ...
    return (
        <div className="experience">
            ...
            <div className="experience-time">
                <Skill image="/bootstrap-logo.png" width={50} height={50} measure="3" years="3 years" />
                <Skill image="/react-logo.png" width={50} height={50} measure="studying" years="Studying" study={true} />
                ...
                <Skill image="/sql-logo.png" width={50} height={50} measure="2" years="2 years" />
            </div>
        </div>
    )
}